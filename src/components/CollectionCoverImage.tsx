...
const CollectionCoverImage = ({
  ...
  return (
    <div className={classnames('w-full min-h-[322px]')}>
      <Link
        href={
      ...
      >
        <div className={classnames('w-full h-full', 'hover:cursor-pointer')}>
          <div
            ...
            style={{
              backgroundImage: `url(${collection.image_url}&w=500&dpr=${window.devicePixelRatio})`
            }}
          />
          ...
          <div
            className={classnames(
              ...
              'p-7',
              'hover:opacity-100 hover:bg-black/80 backdrop-blur-md',
              'transition-all'
            )}
          >
            <div>
            ...
            <div
              className={classnames(
                'self-end h-11 grid grid-cols-[auto_44px]',
                'text-2xl'
              )}
            >
              ...
              <div
                className={classnames(
                  'w-full h-full grid place-content-center rounded-full',
                  'text-white font-serif italic text-[70px] overflow-clip',
                  'bg-primary'
                )}
              >
